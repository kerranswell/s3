    ...
    function d(e, f) {
        ...
        return{title: e.lang.table.title, minWidth: 310, minHeight: CKEDITOR.env.ie ? 310 : 280, onLoad: function () {
            ...
            if (m.info) {
                ...
                if (!this.hasColumnHeaders && (v == 'col' || v == 'both'))for (s = 0; s < k.$.rows.length; s++) {
                    A = new CKEDITOR.dom.element(k.$.rows[s].cells[0]);
                    A.renameNode('th');
                    A.setAttribute('scope', 'row');
                }
                if (this.hasColumnHeaders && !(v == 'col' || v == 'both'))for (r = 0; r < k.$.rows.length; r++) {
            ...
            {id: 'info', label: e.lang.table.title, elements: [
                {type: 'hbox', widths: [null, null], styles: ['vertical-align:top'], children: [
                    {type: 'vbox', padding: 0, children: [
                        {type: 'text', id: 'txtRows', 'default': 1, label: e.lang.table.rows, required: true, controlStyle: 'width:5em', validate: function () {
                        ...
                        {type: 'text', id: 'txtBorder', 'default': 1, label: e.lang.table.border, controlStyle: 'width:3em', validate: CKEDITOR.dialog.validate.number(e.lang.table.invalidBorder), setup: function (i) {
                            ...
                            if (this.getValue())j.setAttribute('border', this.getValue()); else j.removeAttribute('border');
                        }},
                    ...
                    {type: 'vbox', padding: 0, children: [
                        {type: 'hbox', widths: ['5em'], children: [
                            {type: 'text', id: 'txtWidth', controlStyle: 'width:5em', label: e.lang.common.width, title: e.lang.common.cssLengthTooltip, 'default': '100%', getValue: a, validate: CKEDITOR.dialog.validate.cssLength(e.lang.common.invalidCssLength.replace('%1', e.lang.common.width)), onChange: function () {
                        ...
                        {type: 'hbox', widths: ['5em'], children: [
                            {type: 'text', id: 'txtHeight', controlStyle: 'width:5em', label: e.lang.common.height, title: e.lang.common.cssLengthTooltip, 'default': '', getValue: a, validate: CKEDITOR.dialog.validate.cssLength(e.lang.common.invalidCssLength.replace('%1', e.lang.common.height)), onChange: function () {
                                var i = this.getDialog().getContentElement('advanced', 'advStyles');
                        ...
                        {type: 'html', html: '&nbsp;'},
                        {type: 'text', id: 'txtCellSpace', controlStyle: 'width:3em', label: e.lang.table.cellSpace, 'default': 0, validate: CKEDITOR.dialog.validate.number(e.lang.table.invalidCellSpacing), setup: function (i) {
                        ...
                        {type: 'text', id: 'txtCellPad', controlStyle: 'width:3em', label: e.lang.table.cellPad, 'default': 0, validate: CKEDITOR.dialog.validate.number(e.lang.table.invalidCellPadding), setup: function (i) {
