        ...
        <div id="service_refuse_form" class="hidden" data-title="Мы вас не устраиваем?" data-bg="bg-black">
            ...
            <div class="hidden align-center" data-message="success">
                <div class="row msg3">
                    ...
                    +7 (495) 268-14-20 доб. 107 в рабочее время с 10 до 18 по московскому времени.<br/>
                </div>
            </div>
            <div class="hidden" data-message="error">
                <div class="row msg2">Ошибка, пожалуйста, попробуйте еще раз позже.</div>
...
Благодарим за оказанное нам доверие. Ваш запрос передан ответственному лицу. Ответственный: Горохов Виталий. Вы можете с ним связаться, позвонив по телефону<br />
        +7 (495) 268-14-20 доб. 107 в рабочее время с 10 до 18 по московскому времени. Предварительный номер вашего договора:  T03-12/2015.<br/>
<br />
